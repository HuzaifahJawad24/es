                ...
                <ul>
                    {isOpen && (
                        <li>
                            ...
                            <span className="title margin-bottom">Samhir Butt</span>
                        </li>
                    )}
                    ...
                    <li className={showSubMenu.user ? "curser-pointer active" : "curser-pointer"} onClick={() => updateSubMenu('user')}>
                        ...
                        {isOpen && (
                            <ul className = {showSubMenu.user ? "font-size" : "dropdown"}>
                                <li><a href="/master" className="color-white">Add User</a></li>
                                <li><a href="/master" className="color-white">Edit User</a></li>
                                <li><a href="/master" className="color-white">Delete User</a></li>
                            </ul>
                        )}
                    </li>
                    <li className={showSubMenu.menu ? "curser-pointer active" : "curser-pointer"} onClick={() => updateSubMenu('menu')}>
                        ...
                        {isOpen && (
                            <ul className = {showSubMenu.menu ? "font-size" : "dropdown"}>
                                <li><a href="/master" className="color-white">Add Rule</a></li>
                                <li><a href="/master" className="color-white">Edit Rule</a></li>
                                <li><a href="/master" className="color-white">Delete Rule</a></li>
                            </ul>
                        )}
                    </li>
